/**
* @Company 全域旅游
* @Title: VideoCallBackMessage.java 
* @Package org.bana.wechat.mp.callback.msg 
* @author liuwenjie   
* @date Sep 28, 2020 12:17:32 PM 
* @version V1.0   
*/ 
package org.bana.wechat.mp.callback.msg;
...
/** 
* @ClassName: VideoCallBackMessage 
* @Description: 
* @author liuwenjie   
*/
@XmlRootElement(name="xml")
public class VideoCallBackMessage extends CallBackMessage {

	/** 
	* @Fields serialVersionUID : 
	*/ 
	private static final long serialVersionUID = 6921645618483636351L;
