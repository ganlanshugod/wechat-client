 ...
 *  
 */
public abstract class MessageParam extends WeChatParam {
	...
	protected String agentid; //		是	企业应用的id，整型。可在应用的设置页面查看
	protected String safe; //		否	表示是否是保密消息，0表示否，1表示是，默认0
	/**
	...
	*/ 
	...
	public String toString() {
		return "MessageParam [touser=" + touser + ", toparty=" + toparty + ", totag=" + totag + ", msgtype=" + msgtype + ", agentid=" + agentid + ", safe=" + safe
