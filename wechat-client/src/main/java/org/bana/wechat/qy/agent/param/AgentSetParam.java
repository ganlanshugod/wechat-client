/**
* @Company 青鸟软通   
* @Title: AgentSetParam.java 
* @Package org.bana.wechat.qy.agent.param 
* @author Liu Wenjie   
* @date 2015-5-15 下午5:22:10 
* @version V1.0   
*/ 
package org.bana.wechat.qy.agent.param;
...
/** 
 * @ClassName: AgentSetParam 
 * @Description: 设置微信企业号信息的方法
 *  
 */
public class AgentSetParam extends WeChatParam{
	...
	* <p>Description: </p> 
	* @author Liu Wenjie   
	* @date 2015-5-15 下午5:23:52 
	* @return 
	* @see java.lang.Object#toString() 
	*/ 
	@Override
	public String toString() {
		return "AgentSetParam [agentid=" + agentid + ", report_location_flag=" + report_location_flag + ", logo_mediaid=" + logo_mediaid + ", name=" + name + ", description="
				+ description + ", redirect_domain=" + redirect_domain + ", isreportuser=" + isreportuser + ", isreportenter=" + isreportenter + ", access_token=" + access_token
				+ "]";
	}
