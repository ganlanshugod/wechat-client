/**
* @Company 青鸟软通   
* @Title: GetAuthInfoParam.java 
* @Package org.bana.wechat.qy.suite.param 
* @author Liu Wenjie   
* @date 2015-5-14 下午1:22:38 
* @version V1.0   
*/ 
package org.bana.wechat.qy.suite.param;
...
/** 
 * @ClassName: GetAuthInfoParam 
 * @Description: 获取企业号的授权信息的参数对象
 *  
 */
public class GetAuthInfoParam extends WeChatSuiteParam {
	...
	* <p>Description: </p> 
	* @author Liu Wenjie   
	* @date 2015-5-14 下午1:25:07 
	* @return 
	* @see java.lang.Object#toString() 
	*/ 
	@Override
	public String toString() {
		return "GetAuthInfoParam [suite_id=" + suite_id + ", auth_corpid=" + auth_corpid + ", permanent_code=" + permanent_code + ", suite_access_token=" + suite_access_token
				+ "]";
	}
